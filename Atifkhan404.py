...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 03313870659✓')
	    psb('WellCome To ATiF PATHAN')
	    psb('Congratulations ATiF PATHAN Tool Has Been Updated Successfully')
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 Atifkhan404.py')
